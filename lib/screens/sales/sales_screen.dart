...
class SalesScreen extends StatelessWidget {
  ...
  static Widget _resolve(DepartmentModule m) => switch (m.name) {
        'Sales Dashboard'        => const SalesDashboardPage(),
        'Client Management'      => const ClientManagementPage(),
        'Leads'                  => const LeadsPage(),
        'Orders'                 => const OrdersPage(),
        'Pipeline Management'    => const PipelineManagementPage(),
        'Performance Incentives' => const PerformanceIncentivesPage(),
        'Sales Reports'          => const SalesReportsPage(),
        _ => ModulePage(
            moduleName: m.name,
  ...
  Widget build(BuildContext context) {
    final dept = departments.firstWhere((d) => d.name == 'Sales');
...
class SalesReportsPage extends StatelessWidget {
  ...
  static const List<(String, String, IconData)> _reports = [
    ...
    ('Client Revenue',     'Revenue by client account',       Icons.business_rounded),
    ...
    return ModuleScaffold(
      ...
      children: [
        ...
        ..._reports.map((r) => DataRowTile(
              ...
              accentColor: _salesColor, leadingIcon: r.$3)),
        const SizedBox(height: 20),
