...
class EmployeeManagementPage extends StatelessWidget {
  ...
  final List<Map<String, String>> _employees = const [
...
class PerformanceEvalsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ModuleScaffold(
      ...
      children: [
        StatsGrid(cards: const [
          StatCard(label: 'Due This Month', value: '32', icon: Icons.assignment_rounded, color: Colors.orange),
          StatCard(label: 'Completed', value: '19', icon: Icons.check_circle_rounded, color: Colors.green),
          StatCard(label: 'Avg Rating', value: '4.1/5', icon: Icons.star_half_rounded, color: _hrColor),
          StatCard(label: 'Overdue', value: '4', icon: Icons.warning_rounded, color: Colors.red),
        ]),
        const SizedBox(height: 20),
        const SectionHeader(title: 'Pending Reviews', actionLabel: 'Start Review'),
        const SizedBox(height: 8),
        const DataRowTile(title: 'James Carter', subtitle: 'Engineering • Q2 2025', trailing: 'Due Jun 15', accentColor: _hrColor, leadingIcon: Icons.person_rounded, statusColor: Colors.orange),
        const DataRowTile(title: 'Maria Santos', subtitle: 'Marketing • Q2 2025', trailing: 'Due Jun 15', accentColor: _hrColor, leadingIcon: Icons.person_rounded, statusColor: Colors.orange),
        const DataRowTile(title: 'David Kim', subtitle: 'Sales • Q2 2025', trailing: 'Overdue', accentColor: _hrColor, leadingIcon: Icons.person_rounded, statusColor: Colors.red),
        const SizedBox(height: 20),
